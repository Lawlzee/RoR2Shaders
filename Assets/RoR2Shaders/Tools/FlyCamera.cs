    ...
    public class FlyCamera : MonoBehaviour
    {
        ...
        void Awake()
        {
            if (Application.isPlaying)
            {
                ...
                PostProcessVolume postProcessVolume = cameraObject.transform.Find("GlobalPostProcessVolume").GetComponent<PostProcessVolume>();
                foreach (var effect in postProcessProfile.settings)
                {
                    postProcessVolume.profile.AddSettings(effect);
                }
            }
        }
